...
Based on the current version of the db detected by Storage, Program configures itself accordingly exposing the new feature when db v11 is in user or hiding it otherwise. Feature toggle is not required anymore.
